...
export default function NewsPreview(props) {
  ...
  const publishist = ['未发布', '待发布', '已上线', '已下线']
    ...
    <div>
      ...
      >
        <Descriptions size="small" column={3}>
          ...
          <Descriptions.Item label="发布状态"><span style={{ color: colorList[newsInfo.publishState] }}>{publishist[newsInfo.publishState]}</span></Descriptions.Item>
